...
class MockProvider:
    ...
    def generate(self, prompt: str) -> str:
        ...
        if '"variants"' in lowered and "hook variants" in lowered:
        ...
        if "schema: {\"score\"" in lowered and "hook text:" in lowered:
            return '{"score":8.6,"notes":"Clear and specific promise; slight risk of sounding absolute.","risk_level":2}'
        if '"review"' in lowered and "analyze retention risks" in lowered:
